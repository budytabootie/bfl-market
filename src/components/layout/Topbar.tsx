...
export async function Topbar({ permissions: permProp = [], user, variant }: TopbarProps) {
  ...
  return (
    <header className="flex items-center justify-between px-4 md:px-6 py-4 border-b border-slate-800/80 bg-linear-to-r from-bfl-bg/80 to-slate-950/70 backdrop-blur">
      <div>
